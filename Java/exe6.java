...
class Async_Producer extends Thread {
   ...
   public Async_Producer(BankAccount acct) {
      account = acct;
   }
...
class sync_Producer extends Thread {
   ...
   public sync_Producer(BankAccount acct) {
      account = acct;
   }
...
class Async_Consumer extends Thread {
   ...
   public Async_Consumer(BankAccount acct) {
      account = acct;
   }
...
class sync_Consumer extends Thread {
   ...
   public sync_Consumer(BankAccount acct) {
      account = acct;
   }
